# Clasificador de reclamos de soporte al cliente
...
La versión nueva es mejor por tres razones:
1.  **Sirve más**, porque cada respuesta ya viene con prioridad, intención y qué acción tomar.
2.  **Se puede evaluar**, porque al venir siempre en el mismo formato es fácil revisar si está bien o mal.
3.  **Es más segura**, porque le prohibí inventar datos y la obligué a avisar cuando no está segura en vez de adivinar.
...
### Respondiendo las preguntas del desafío:
-   La decisión más importante fue exigir un **formato de salida fijo** con criterios de prioridad claros, porque sin eso nada se puede medir ni automatizar.
-   El peor problema del prompt inicial era que la **tarea era ambigua**.
-   La técnica que más aportó fue la **salida estructurada**.
-   Sé que el mejorado funciona mejor porque en la matriz de evaluación sube en **formato, utilidad y control de riesgo**.
-   El riesgo que va a seguir ahí es **confundir el tono con la urgencia real**.
-   Antes de usarlo en serio, probaría con **muchos casos reales anonimizados** y haría un **A/B test** entre dos versiones del prompt.